  ...
  return (
    <div className='overflow-hidden dark:-mb-32 dark:mt-[-4.75rem] dark:pb-32 dark:pt-[4.75rem]'>
      <div className='py-16 sm:px-2 lg:relative lg:px-0 lg:py-20'>
        <div className='mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 lg:max-w-8xl lg:grid-cols-2'>
          <div className='relative z-10 md:text-center lg:text-left'>
            <div className='relative'>
              ...
              <p className='mt-3 text-2xl tracking-tight text-slate-400'>
                Subscribe to our documentation service and harness the power of
