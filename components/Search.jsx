...
export function Search() {
  ...
  return (
    <>
      <button
        type='button'
        className='group flex items-center justify-center w-full h-10 md:w-auto md:max-w-md md:rounded-lg md:py-2.5 md:pl-4 md:pr-3.5 md:text-sm md:ring-1 md:ring-slate-200 md:hover:ring-slate-300 lg:max-w-[90%] lg:w-full dark:bg-slate-800/75 dark:ring-inset dark:ring-white/5 dark:hover:bg-slate-700/40 dark:hover:ring-slate-500'
        {...buttonProps}
      >
