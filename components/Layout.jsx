...
function Header() {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-grow basis-0 items-center mx-10">
...
export function Layout({ children }) {
  ...
  return (
    <div className="flex w-full flex-col">
      ...
      <div className="relative flex w-full max-w-8xl flex-auto justify-center sm:px-2 lg:px-8 xl:px-12">
