...
function Header() {
  ...
  return (
    <header
      className={clsx(
        'sticky top-0 z-50 flex flex-none flex-wrap items-center justify-between bg-white px-4 py-10 shadow-md shadow-pena-900/5 transition duration-500 sm:px-6 lg:px-8 dark:shadow-none',
        isScrolled
  ...
  return (
    <div className='flex w-full flex-row max-h-screen'>
      ...
      <div className='flex flex-col w-full overflow-y-scroll px-4 lg:pl-8 lg:pr-0 xl:px-16'>
        <Header />
        <div className='bg-red-100'>{isHomePage && <Hero />}</div>
